...
app.post("/api/tampil_pengalaman_kerja", (req, res) => {
  ...
  let nama_field = '*';
  let kondisi = 'ORDER BY pengalaman_kerja ASC';
  try {
    sql = PublikFungsi.CariDataDebug(
      nama_tabel,
      nama_field,
...
app.post("/api/ubah_pendidikan", (req, res) => {
  ...
  let nama_field = 'nama = "' + data.nama_instansi + '",';
  nama_field += 'jenis_kelamin = "' + data.range_tahun + '",';
  nama_field += 'tgl_lahir = "' + data.jurusan + '"';

  let kondisi = 'kode = "' + data.kd_pendidikan + '"';
...
app.post("/api/tb_pengalaman_kerja", (req, res) => {
  console.log("Tampil pengalaman_kerja");
  let data = {
    token: req.body.token,
    jam_request: PublikFungsi.WaktuSekarang("DD-MM-YYYY HH:mm:ss") + " Wib.",
...
app.post("/api/tambah_pengalaman_kerja", (req, res) => {
  console.log("Tambah pengalaman kerja");
  let data = {
    token: req.body.token,
    nama_instansi : req.body.nama_instansi
  ...
  let sql;
  let nama_tabel = 'tb_pengalaman_kerja';
  let nama_field = 'nama_instansi,jabatan_terakhir,terakhir_bekerja,tgl_lahir';
  let value_field = '"' + data.nama_instansi + '",';
